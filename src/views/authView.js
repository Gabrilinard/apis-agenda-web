      ...
      try {
        await dbPromise.query(
          `UPDATE usuario SET 
           ...
           WHERE id = ?`,
          [
            PROFISSIONAL_DEMO.descricao, PROFISSIONAL_DEMO.publicoAtendido, PROFISSIONAL_DEMO.modalidade,
            PROFISSIONAL_DEMO.valorPresencial, PROFISSIONAL_DEMO.valorOnline, PROFISSIONAL_DEMO.valorDomiciliar,
            PROFISSIONAL_DEMO.horariosAtendimento, PROFISSIONAL_DEMO.diasAtendimento,
            PROFISSIONAL_DEMO.ufRegiao, PROFISSIONAL_DEMO.cidade, rows[0].id
          ]
        );
      } catch (e) {
